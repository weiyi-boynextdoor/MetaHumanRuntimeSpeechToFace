...
*/
UCLASS()
class URuntimeSpeechToFaceBPLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_UCLASS_BODY()

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Initialize RuntimeSpeechToFaceBPLibrary", Category = "RuntimeSpeechToFace"))
	static bool Initialize();

	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Execute Sample function", Category = "RuntimeSpeechToFace"))
	static float RuntimeSpeechToFaceSampleFunction(float Param);
};
